...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Pokycoin Core pokycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pokycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pokycoin transaction") + "\n" +
              "  pokycoin-tx [options] -create [commands]   " + _("Create hex-encoded pokycoin transaction") + "\n" +
              "\n";

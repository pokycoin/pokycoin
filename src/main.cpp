...
#if defined(NDEBUG)
# error "Pokycoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Pokycoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("pokycoin-scriptch");
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Pokycoin: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet & regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Pokycoin: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
